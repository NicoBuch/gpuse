...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Wolox/gpuse?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Error Tracking](https://d26gfdfi90p7cf.cloudfront.net/rollbar-badge.144534.o.png)](https://rollbar.com)

`[![Codestats](http://codestats-url/organizations/your-organization/projects/gpuse/badge)](http://codestats-url/organizations/your-organization/projects/gpuse/badge)`
...
- Clone the repository by running `git clone git@github.com:Wolox/gpuse.git`
- Go to the project root by running `cd gpuse`
...
```bash
  ...
  CREATE ROLE "gpuse" LOGIN CREATEDB PASSWORD 'gpuse';
```
